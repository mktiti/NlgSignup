...
public class DBUtil {
    ...
    private static final String CREATE_EVENT = "CREATE TABLE EVENT(ID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1) PRIMARY KEY, NAME VARCHAR(200) NOT NULL, MAX_SIGNUPS INT NOT NULL, UNIQUE(NAME))";
